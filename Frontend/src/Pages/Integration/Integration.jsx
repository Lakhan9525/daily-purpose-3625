...
const Integration = () => {
  ...
  let update = data.filter((data) => {
    return sort ? data.type === sort : data;
  });
    ...
    <Box style={{ overflow: "hidden" }}>
      ...
      <div className={styles.flextop}>
        <Box style={{ marginLeft: "10%" }}>
          <h1 style={{ fontSize: "45px", width: "85%" }}>
          ...
          <div style={{ display: "inline-block" }}>
            <button className={styles.buttontrack}>
              {" "}
              <div style={{ display: "flex", gap: "10px" }}>
                <img
                  ...
                  alt=""
                />
                <h5 style={{ color: "white" }}>Track time in Chrome</h5>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                <img
                  ...
                  alt=""
                />
                <h5 style={{ color: "white" }}>Track time in Edge</h5>
              </div>
            </button>
          </div>
        </Box>
      ...
      <div style={{ marginTop: "150px" }} className={styles.app}>
        <div>
          {" "}
          <button className={styles.btnapp} onClick={() => setsort("")}>
            <img
        ...
        <div>
          ...
          <button
            ...
            onClick={() => setsort("projectmanagement")}
          >
            <img
        ...
        <div>
          {" "}
          <button className={styles.btnapp} onClick={() => setsort("helpdesk")}>
            <img
        ...
        <div>
          ...
          <h1 className={styles.title}>Collabrator</h1>
        </div>
        <div>
          {" "}
          <button className={styles.btnapp}>
            <img
              src="https://cdn-m.timecamp.com/img/greenbranding/dev.svg"
              alt=""
            />
          </button>
          <h1 className={styles.title}></h1>Development
        </div>
        <div>
          {" "}
          <button className={styles.btnapp}>
          ...
          <h1 className={styles.title}>Accounting & Invoicing</h1>
        </div>
        <div>
          <button className={styles.btnapp}>
            <img
      ...
      <Box w={[500, 900, 1500]}>
        <div className={styles.bottom}>
          ...
          <p>
            Remember, you can't improve something if you're not measuring it! If
            you're tired of the constant guessing, give TimeCamp a go!
          </p>
          <button
            className={styles.btn2}
            style={{ backgroundColor: "rgb(247,184,1)" }}
          >
            Try TimeCmp for free{" "}
          </button>
          <button className={styles.btn3} style={{ marginLeft: "30px" }}>
            Contact Sale
          </button>
        </div>
      </Box>
